...
public class main {
    ...
    public static String[][] populateIPRange(String ip, int min, int max){
        ...
        while(index2 < Math.ceil(1.0*max/NUM_WORKERS)){
            ...
            if (index2 * NUM_WORKERS + index1 >= max){
                ...
                // Otherwise, populate the next ip address into IPs.
                s = ip + "." + min;
            }
            IPs[index1][index2] = s;
            min++;
    ...
    public static void main(String[] args) throws IOException {
       ...
       Clock clock = Clock.systemDefaultZone();// Clock for timing.
    ...
    public static void printOpening(){// Because what program is complete without ASCII art?
        ...
        System.out.println("$$\\   $$ |$$ |  $$ |  $$ |     $$ |           $$\\   $$ |$$ |  $$\\ $$ |  $$ |$$ |\\$$$ |$$ |\\$$$ |$$ |      $$ |  $$ |");
        System.out.println("\\$$$$$$  |$$ |  $$ |$$$$$$\\    $$ |           \\$$$$$$  |\\$$$$$$  |$$ |  $$ |$$ | \\$$ |$$ | \\$$ |$$$$$$$$\\ $$ |  $$ |");
        System.out.println(" \\______/ \\__|  \\__|\\______|   \\__|            \\______/  \\______/ \\__|  \\__|\\__|  \\__|\\__|  \\__|\\________|\\__|  \\__|\033[0m");
        System.out.println();
    }
}
